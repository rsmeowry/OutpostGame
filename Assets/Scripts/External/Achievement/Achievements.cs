...
namespace External.Achievement
{
    ...
    {
        public static readonly StateKey Tutorial = new StateKey("tutorial");
        ...
        public static readonly StateKey Hydroelectricity = new StateKey("hydroelectricity");
        public static readonly StateKey Final = new StateKey("final");
        public static readonly StateKey MoneyGained = new StateKey("money");
        public static readonly StateKey MoneySpent = new StateKey("money_spent");
